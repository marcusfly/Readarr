                               ...
                               IHandle<QueueUpdatedEvent>, IHandle<PendingReleasesUpdatedEvent>
    {
        ...
        public QueueStatusResource GetQueueStatus()
        {
            ...
            var resource = new QueueStatusResource
            {
                ...
                Count = queue.Count(q => q.Author != null || q.Magazine != null) + pending.Count,
                UnknownCount = queue.Count(q => q.Author == null && q.Magazine == null),
                Errors = queue.Any(q => (q.Author != null || q.Magazine != null) && q.TrackedDownloadStatus == TrackedDownloadStatus.Error),
                Warnings = queue.Any(q => (q.Author != null || q.Magazine != null) && q.TrackedDownloadStatus == TrackedDownloadStatus.Warning),
                UnknownErrors = queue.Any(q => q.Author == null && q.Magazine == null && q.TrackedDownloadStatus == TrackedDownloadStatus.Error),
                UnknownWarnings = queue.Any(q => q.Author == null && q.Magazine == null && q.TrackedDownloadStatus == TrackedDownloadStatus.Warning)
            };
